function warped_image = warp_image(current_shape, input_image,warpmodel)
...
base_shape = reshape(warpmodel.base_shape,[],2);
base_texture = warpmodel.warp_map;
triangles = warpmodel.triangles;
resolution = size(base_texture);
